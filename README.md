Durante tutto il piano leggere The Phoenix Project

Session 1 - What is DevOps? \[DOING\]
=====================================

*   Articoli e presentazioni \[done\]
    

*   [DevOps / Infrastructure as Code](https://docs.google.com/presentation/d/1Xkr2ioe6cXD9jFM9ETRCm4e-NPoLi_54n_u1yCgHAA4/edit#slide=id.g9b7ec55c6_0_0) \[done\]
    
*   [What is this devops thing anyway](http://www.jedi.be/blog/2010/02/12/what-is-this-devops-thing-anyway/) \[done\]
    
*   [10 practices for effective devops](http://www.drdobbs.com/architecture-and-design/top-10-practices-for-effective-devops/240149363) \[done\]
    
*   [Deployment is just a part of dev/ops cooperation, not the whole thing](http://www.kitchensoap.com/2009/12/12/devops-cooperation-doesnt-just-happen-with-deployment/) \[done\]
    
*   [There’s No Such Thing as a “Devops Team”](http://continuousdelivery.com/2012/10/theres-no-such-thing-as-a-devops-team/) \[done\]
    

*   Libri
    

*   Leggere [Pomodoro technique](https://drive.google.com/open?id=0B8YNMs86FJQtOGJMOUxHQjF2Rjg&authuser=0) \[done\]
    
*   Capitolo 2 Implementing Lean Software Development \[wait\]
    
*   Capitoli 1-3 di [Extreme Programming Explained](https://drive.google.com/open?id=0B8YNMs86FJQtdUN2WTBGM096TTA&authuser=0) \[done\]
    

*   Video
    

*   [10+ Deploys Per Day: Dev and Ops Cooperation at Flickr](https://www.youtube.com/watch?v=LdOe18KhtT4) \[done\]
...
*   [Code School Try Git](https://try.github.io/levels/1/challenges/1) \[done\]
    
*   [Code School Try Ruby](https://www.codeschool.com/courses/try-ruby) \[done\]
    
*   Chef essentials \[done\]
...
*   [Configuration Synchronization](http://martinfowler.com/bliki/ConfigurationSynchronization.html) \[done\]
    
*   [Immutable Servers](http://martinfowler.com/bliki/ImmutableServer.html) \[done\]
    

*   [Snow flake Server](http://martinfowler.com/bliki/SnowflakeServer.html) \[done\]
*   [Phoenix Server](http://martinfowler.com/bliki/PhoenixServer.html) \[done\]
...
*   [Introduction to Amazon EC2](https://www.youtube.com/watch?v=A4V_QFLZgv4) \[done\]
    
*   [EC2 Masterclass](https://www.youtube.com/watch?v=jLVPqoV4YjU)
    
*   [CloudFormation Masterclass](https://www.youtube.com/watch?v=6R44BADNJA8) \[done\]
...
*   Kanban in Action: Part 2 - the case study \[wait\]
    
*   Capitoli 4-7 Extreme Programming Explained \[wait\]
    

*   Esercizi
    

*   AWS Technical Essentials  \[doing\]
    
*   [Infrastructure as code on AWS](https://github.com/xpeppers/infrastructure-as-code-on-aws)  \[doing\]
    
*   [Ansible get started](https://www.ansible.com/get-started) \[doing\]
    

*   [Test Kitchen con Ansible](https://github.com/neillturner/kitchen-ansible) \[doing\]
    

*   Replicare [Infrastructure as code on AWS](https://github.com/xpeppers/infrastructure-as-code-on-aws) usando Ansible \[doing\]
    

*   Lambda and Serverless architecture

*   [AWS Lambda: How It Works ](http://docs.aws.amazon.com/lambda/latest/dg/lambda-introduction.html)\[done\]
*   [AWS Serverless Multi-Tier Architectures](https://d0.awsstatic.com/whitepapers/AWS_Serverless_Multi-Tier_Architectures.pdf) \[done\]
*   [AWS Lambda Documentation](https://aws.amazon.com/documentation/lambda/) \[done\]

*   [AWS API gateway](https://aws.amazon.com/api-gateway/) \[done\]
*   [Getting started with aws proxy](http://docs.aws.amazon.com/apigateway/latest/developerguide/getting-started-aws-proxy.html) \[done\]
*   Identity and access management

*   [IAM Role](http://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles.html) \[done\]
*   [What is IAM](http://docs.aws.amazon.com/IAM/latest/UserGuide/introduction.html) \[done\]
...
*   [Introduzione continuous Integration](http://www.martinfowler.com/articles/continuousIntegration.html) \[done\]
    
*   [Introduzione continuous Delivery](http://www.martinfowler.com/bliki/ContinuousDelivery.html) \[done\]
    
*   [AWS Code Deploy](http://docs.aws.amazon.com/codedeploy/latest/userguide/welcome.html) \[done\]
    

*   Video
    

*   [Continuous Delivery on Java Projects](https://www.youtube.com/watch?v=Y6juAsiurO4)\[done\]
    

*   [Slide della presentazione](http://pt.slideshare.net/xpeppers/continuous-delivery-in-java) \[done\]
...
*   Capitoli 1-3 Continuous Delivery \[doing\]
    
*   Capitoli 3,4,5 Implementing Lean Software Development \[wait\]
    

*   Esercizi
    

*   [Continuous Delivery jumpstart](https://docs.google.com/presentation/d/1TONDWUBCbHsH27pi1EMsx1wfWyWQRX4f-bPZAULRHNo/edit#slide=id.gb3550ec09_2_0) \[done\]
